...
The mean of the dataset without NAs is **`r new_mean`**, which compares to the value of **`r mean`** obtained with the dataset that included NAs.

The median of the dataset without NAs is **`r new_median`**, which compares to the value of **`r median`** obtained with the dataset that included NAs.
